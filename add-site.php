...
<html lang="en">
            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#"> Add Site</a>
                        </li>
                    </ul>
                </div>
                                ...
                                <div class="bor">
                                    <form id="form-data" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <select class="input-field col s6" id="manager" name="manager" class="manager">
                                                <option value="" disabled selected>Select Manager</option>
                                                <?php
                                                $MANAGER = new User();
                                                foreach ($MANAGER->getAllManagerByType(4) as $manager) {
                                                    ?>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="submit" id="create" class="waves-effect waves-light btn-large" value="Submit">
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    <script src="js/ajax/site.js" type="text/javascript"></script>
