                ...
                <div class="sb2-2">
                    <div class="sb2-2-2">
                        <ul>
                            ...
                            <li class="active-bre"><a href="#"> Purchase Orders</a>
                            </li>
                        </ul>
                    </div>
                    <div class="sb2-2-3">
                                        ...
                                        <div class="table-responsive table-desi">
                                            <table class="table table-hover" id="datatables-basic">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($PURCHASE_ORDER->getAll() as $purchase_order) {
                                                        ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                echo $MATERIAL->getName($purchase_order['item']);
                                                                ?>
                                                            </td>
                                                            <td><?= $purchase_order['price'] ?></td>
                                                            <td><?= $purchase_order['quantitty'] ?></td>
                                                            <td>
                                                                <?php
                                                                $SITE = new Site();
                                                                echo $SITE->getName($purchase_order['siteId']);
                                                                ?>
                                                            </td>
                                                            <td><?= $purchase_order['supplier'] ?>
                                                            </td>
                                                            <td>
                                                                <?php
                                                                if ($purchase_order['staff'] == 0) {
                                                                    $MANAGER = new User();
                                                                    echo "Not Approved";
                                                                } else {
                                                                    $MANAGER = new User();
                                                                    echo $MANAGER->getManagerName($purchase_order['staff']);
                                                                }
                                                                ?>
                                                            </td>
                                                            <td>
                                                                ...
                                                                if ($purchase_order['status'] == 0) {
                                                                    echo "Not Approved";
                                                                } else if ($purchase_order['status'] == 1) {
                                                                    echo "Approved";
                                                            ...
                                                            <td><?= $purchase_order['createdAt'] ?></td>
                                                            <td>
                                                                <a href="view-purchase-order.php?id=<?= $purchase_order['id'] ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                            </td>
