        ...
        <div class="sb2-1">
            ...
            <div class="sb2-13">
                <ul class="collapsible" data-collapsible="accordion">
                    ...
                    <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-list-ul" aria-hidden="true"></i> Manage Supplier</a>
                        <div class="collapsible-body left-sub-menu">
                            <ul>
                                ...
                                <li><a href="./manage-supplier.php">Manage</a> </li>
                    ...
                    <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-list-ul" aria-hidden="true"></i> Manage Sites</a>
                        <div class="collapsible-body left-sub-menu">
                            <ul>
                                ...
                                <li><a href="./add-site.php">Creat Site</a> </li>
                    ...
                    <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-list-ul" aria-hidden="true"></i> Manage Raw Mateial</a>
                        <div class="collapsible-body left-sub-menu">
                            <ul>
                                </li>
